...
def _transform_kernels_ab_relu(kernels, a, b, do_backprop, do_stabilize):
  ...
  # if count == 0:
  #   print("******************************")
  #   print("intial Kernel:",nngp.shape)
  #   k_evolve.append(lax.abs(np.linalg.norm(nngp)))
  #   print("******************************")
  #   count +=1
  ...
  # print("******************************")
  # print("Kernel:",nngp.shape)
  # k_evolve.append(lax.abs(np.linalg.norm(nngp)))
  # print(" Kernel evolution:", len(k_evolve))
  # print("******************************")
